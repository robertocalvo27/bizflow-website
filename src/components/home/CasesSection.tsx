      ...
      <div className="container mx-auto px-4">
        ...
        <div className="mb-16 bg-bizflow-gray-50 rounded-xl overflow-hidden shadow-md">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
            <div className="relative h-64 md:h-96 lg:h-full">
              <Image
                src="/images/caso-exito-smith-nephew.jpg"
                alt="Smith & Nephew - Optimización de operaciones"
                fill
        ...
        <Tabs defaultValue="manufactura" className="w-full">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <Card className="overflow-hidden hover:shadow-lg transition-all">
                <div className="relative h-48">
                  <Image
                    src="/images/caso-manufactura-1.jpg"
                    alt="Optimización de líneas de producción"
                    fill
                    className="object-cover"
                    crossOrigin="anonymous"
                  />
              ...
              <Card className="overflow-hidden hover:shadow-lg transition-all">
                <div className="relative h-48">
                  <Image
                    src="/images/caso-manufactura-2.jpg"
                    alt="Digitalización de mantenimiento"
                    fill
                    className="object-cover"
                    crossOrigin="anonymous"
                  />
              ...
              <Card className="overflow-hidden hover:shadow-lg transition-all">
                <div className="relative h-48">
                  <Image
                    src="/images/caso-manufactura-3.jpg"
          ...
          <TabsContent value="mineria" className="space-y-0">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <Card className="overflow-hidden hover:shadow-lg transition-all">
                <div className="relative h-48">
                  <Image
                    src="/images/caso-mineria-1.jpg"
                    alt="Seguridad minera"
                    fill
                    className="object-cover"
                    crossOrigin="anonymous"
                  />
          ...
          <TabsContent value="alimentos" className="space-y-0">
            {/* Contenido para Alimentos y Bebidas */}
          </TabsContent>
        </Tabs>
