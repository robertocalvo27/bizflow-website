  ...
  return (
    <section className="py-24 md:py-32 relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden z-0">
        <div className="absolute top-10 right-10 w-64 h-64 rounded-full bg-bizflow-purple-600 mix-blend-overlay opacity-20 blur-2xl"></div>
        <div className="absolute bottom-20 left-20 w-80 h-80 rounded-full bg-bizflow-blue-400 mix-blend-overlay opacity-20 blur-2xl"></div>
      </div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
            <ScheduleMeetingModal>
              <Button size="lg" className="bg-white hover:bg-bizflow-blue-50 text-bizflow-blue-900 font-medium">
