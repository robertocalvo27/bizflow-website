        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            <h1 className="text-4xl lg:text-5xl xl:text-6xl font-bold text-bizflow-gray-900 mb-6">
              Minería <br />
              <span className="text-bizflow-blue-600">Digital y Sostenible</span>
            </h1>
            <p className="text-lg text-bizflow-gray-600 mb-8 lg:mb-12">
              Transforme sus operaciones mineras con soluciones digitales que maximizan la 
              productividad, seguridad y sostenibilidad en cada etapa del proceso extractivo.
            </p>
            ...
            <div className="mt-12 grid grid-cols-2 gap-8">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <div className="text-2xl font-bold text-bizflow-gray-900">+45%</div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <div className="text-2xl font-bold text-bizflow-gray-900">-30%</div>
          ...
          >
            <div className="relative aspect-[4/3] lg:aspect-[16/12]">
              <Image
                src="/images/mineria-dashboard.webp"
                alt="Dashboard de Minería Digital"
                fill
            ...
            >
              ...
              <p className="text-sm text-bizflow-gray-600">
                Monitoreo en tiempo real de operaciones y KPIs de producción minera
              </p>
            </motion.div>
          </motion.div>
        </div>
