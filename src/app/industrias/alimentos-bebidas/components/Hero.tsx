        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            <h1 className="text-4xl lg:text-5xl xl:text-6xl font-bold text-bizflow-gray-900 mb-6">
              ...
              <span className="text-bizflow-blue-600">Inteligencia en Producción</span>
            </h1>
            <p className="text-lg text-bizflow-gray-600 mb-8 lg:mb-12">
              Transforme su industria alimentaria con soluciones digitales que garantizan 
              calidad, trazabilidad y eficiencia en toda la cadena de producción.
            </p>
            <div className="flex flex-col sm:flex-row gap-4">
              <ScheduleMeetingModal>
                <Button size="lg" className="w-full sm:w-auto">
                  Optimizar mi Producción
            ...
            <div className="mt-12 grid grid-cols-2 gap-8">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="text-sm text-bizflow-gray-600">Eficiencia Productiva</div>
                </div>
              </div>
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="text-sm text-bizflow-gray-600">Control de Calidad</div>
                </div>
              </div>
            </div>
          </motion.div>
          ...
          >
            <div className="relative aspect-[4/3] lg:aspect-[16/12]">
              <Image
                src="/images/alimentos-dashboard.webp"
                alt="Dashboard de Producción de Alimentos"
                fill
            ...
            >
              <div className="flex items-center gap-4 mb-4">
                ...
                <div className="font-semibold text-bizflow-gray-900">Trazabilidad Total</div>
              </div>
              <p className="text-sm text-bizflow-gray-600">
                Seguimiento en tiempo real de la producción y control de calidad alimentaria
              </p>
            </motion.div>
          </motion.div>
        </div>
