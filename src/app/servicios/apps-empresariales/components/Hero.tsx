      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            >
              <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-bizflow-blue-900 mb-6">
                Apps Empresariales que transforman procesos complejos en flujos digitales simples
              </h1>
              <p className="text-xl text-bizflow-gray-600 mb-8">
            ...
            >
              <div className="flex items-start space-x-3">
                <CheckCircle2 className="h-6 w-6 text-bizflow-green-500 flex-shrink-0 mt-1" />
                <p className="text-bizflow-gray-700">
                  <span className="font-semibold text-bizflow-blue-900">Desarrollo Ágil:</span> Entregamos MVPs funcionales en 4-6 semanas, no en meses
                </p>
              </div>
              <div className="flex items-start space-x-3">
                <CheckCircle2 className="h-6 w-6 text-bizflow-green-500 flex-shrink-0 mt-1" />
                <p className="text-bizflow-gray-700">
                  <span className="font-semibold text-bizflow-blue-900">Integración Total:</span> Conectamos su app con SAP, Oracle, y sistemas legacy sin problemas
                </p>
              </div>
              <div className="flex items-start space-x-3">
                <CheckCircle2 className="h-6 w-6 text-bizflow-green-500 flex-shrink-0 mt-1" />
                <p className="text-bizflow-gray-700">
                  <span className="font-semibold text-bizflow-blue-900">Experiencia Industrial:</span> Apps diseñadas por expertos que entienden su operación
                </p>
              </div>
            </motion.div>
          </div>
